package com.dingsheng.decent.util.db;
...
//	private final static String MACHINE_CODE = PropertyConfig
//            .getPropertyValue("project.machineCode");
    private final static String MACHINE_CODE = "01";
	//private static Long preVal = new Long(0);
	private static Long preVal = Long.valueOf(0l);
